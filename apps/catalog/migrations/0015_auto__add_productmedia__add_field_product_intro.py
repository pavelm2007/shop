...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catalog_productmedia', (
        ...
        db.send_create_signal('catalog', ['ProductMedia'])

        # Adding field 'Product.intro'
        db.add_column('catalog_product', 'intro',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('catalog_productmedia')

        # Deleting field 'Product.intro'
        db.delete_column('catalog_product', 'intro')

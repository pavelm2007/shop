...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.is_deal'
        db.add_column(u'catalog_product', 'is_deal',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Product.is_popular'
        db.add_column(u'catalog_product', 'is_popular',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Product.is_novelty'
        db.add_column(u'catalog_product', 'is_novelty',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.is_deal'
        db.delete_column(u'catalog_product', 'is_deal')

        # Deleting field 'Product.is_popular'
        db.delete_column(u'catalog_product', 'is_popular')

        # Deleting field 'Product.is_novelty'
        db.delete_column(u'catalog_product', 'is_novelty')

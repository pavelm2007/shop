...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('catalog_category', 'type')

        # Adding field 'Category.view'
        db.add_column('catalog_category', 'view',
    ...
    def backwards(self, orm):
        ...
        db.add_column('catalog_category', 'type',
                      self.gf('django.db.models.fields.CharField')(default='P', max_length=1),
                      keep_default=False)

        # Deleting field 'Category.view'
        db.delete_column('catalog_category', 'view')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductOption.option_value'
        db.alter_column(u'catalog_productoption', 'option_value_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalog.OptionValue']))

    def backwards(self, orm):

        # Changing field 'ProductOption.option_value'
        db.alter_column(u'catalog_productoption', 'option_value_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2013, 8, 12, 0, 0), to=orm['catalog.OptionValue']))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SiteTowns'
        db.create_table(u'catalog_sitetowns', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('item_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'catalog', ['SiteTowns'])


    def backwards(self, orm):
        # Deleting model 'SiteTowns'
        db.delete_table(u'catalog_sitetowns')

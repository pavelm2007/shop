...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductMedia.description'
        db.alter_column('catalog_productmedia', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'ProductMedia.description'
        db.alter_column('catalog_productmedia', 'description', self.gf('django.db.models.fields.TextField')())

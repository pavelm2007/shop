...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalog_product', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cities', null=True, to=orm['catalog.SiteTowns']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.city'
        db.delete_column(u'catalog_product', 'city_id')
    ...
    models = {
        ...
        u'catalog.product': {
            ...
            'city': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'cities'", 'null': 'True', 'to': u"orm['catalog.SiteTowns']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'catalog.sitetowns': {
            'Meta': {'ordering': "('position', 'name')", 'object_name': 'SiteTowns'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),

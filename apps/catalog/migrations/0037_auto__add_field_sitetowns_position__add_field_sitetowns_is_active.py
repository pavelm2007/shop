...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteTowns.position'
        db.add_column(u'catalog_sitetowns', 'position',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=100),
                      keep_default=False)

        # Adding field 'SiteTowns.is_active'
        db.add_column(u'catalog_sitetowns', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteTowns.position'
        db.delete_column(u'catalog_sitetowns', 'position')

        # Deleting field 'SiteTowns.is_active'
        db.delete_column(u'catalog_sitetowns', 'is_active')
    ...
    models = {
        ...
        u'catalog.sitetowns': {
            'Meta': {'ordering': "('name',)", 'object_name': 'SiteTowns'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),

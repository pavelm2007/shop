...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Carousel.product'
        db.alter_column('catalog_carousel', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Product'], null=True))

    def backwards(self, orm):

        # Changing field 'Carousel.product'
        db.alter_column('catalog_carousel', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['catalog.Product']))

    models = {
        'catalog.carousel': {
            'Meta': {'object_name': 'Carousel'},
            'category': ('mptt.fields.TreeForeignKey', [], {'to': "orm['catalog.Category']", 'null': 'True', 'blank': 'True'}),

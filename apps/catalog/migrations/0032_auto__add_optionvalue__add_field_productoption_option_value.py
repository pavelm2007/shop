...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductOption.option_value'
        db.add_column(u'catalog_productoption', 'option_value',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='optionvalue', to=orm['catalog.OptionValue']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProductOption.option_value'
        db.delete_column(u'catalog_productoption', 'option_value_id')
    ...
    models = {
        ...
        u'catalog.productoption': {
            ...
            'option_value': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'optionvalue'", 'to': u"orm['catalog.OptionValue']"}),

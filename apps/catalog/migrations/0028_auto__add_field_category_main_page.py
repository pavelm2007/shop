...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.main_page'
        db.add_column(u'catalog_category', 'main_page',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.main_page'
        db.delete_column(u'catalog_category', 'main_page')

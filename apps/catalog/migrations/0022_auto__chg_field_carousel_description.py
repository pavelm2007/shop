...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Carousel.description'
        db.alter_column('catalog_carousel', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Carousel.description'
        db.alter_column('catalog_carousel', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

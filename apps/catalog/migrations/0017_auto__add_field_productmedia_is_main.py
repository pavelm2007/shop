...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductMedia.is_main'
        db.add_column('catalog_productmedia', 'is_main',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductMedia.is_main'
        db.delete_column('catalog_productmedia', 'is_main')
